...
# --- Generic Type Variables for strong typing ---
...
def create_crud_router(
        *,
        ...
        prefix: str,
        tags: List[str],
        pk_field_name: str = "id",       # The name of the primary key column
        name_field: str = "name"     # A common field for user-friendly messages
) -> APIRouter:
    """
    Creates and returns a FastAPI APIRouter with full CRUD functionality.
    Assumes the model has an 'organisation_id' field for multi-tenancy.
    """
